...
public class CategoryController {
    ...
    @GetMapping("/mostProducts")
    public ResponseEntity getCategoryWithMostProducts() {
        String result = categoryService.getCategoryWithMostProducts(categoryService.getCategories(), productService.getProducts());

        if (result.isEmpty()) {
            return ResponseEntity.status(HttpStatus.BAD_REQUEST).body( new ApiResponse( "No products found"));
        }
